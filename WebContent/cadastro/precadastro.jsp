                                                    ...
                                                    <div id="color_23">
                                                      <div class="row">
                                                        ...
                                                        <div class="form-group col-md-7">
                                                          <label for="campo2">CNPJ / CPF</label><input type="text" name="documento" id="cpfcnpj3" class="form-control" maxlength="14" minlength="11"  placeholder="Digite seu CPF" autofocus />
                                                        </div>
                                                      </div>
                                                      <div class="row">
                                                        ...
                                                        Eu aceito os termos de uso, <a href="controller.do?command=DownloadTermos&id=${Empresa.id}&nome=${Empresa.data}&tipo=Administrador" >Download Termo Empresa</a> ou <a href="controller.do?command=DownloadTermos&id=${Cartorio.id}&nome=${Cartorio.data}&tipo=Administrador" >Download Termo Cartorio</a>
                                                        <br>
                                                        <br>
